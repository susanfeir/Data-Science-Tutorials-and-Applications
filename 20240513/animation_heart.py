...
CANVAS_WIDTH = 840  # 画布の幅
CANVAS_HEIGHT = 680  # 画布の高さ
CANVAS_CENTER_X = CANVAS_WIDTH / 2  # 画布中心点のX轴座標
CANVAS_CENTER_Y = CANVAS_HEIGHT / 2  # 画布中心点のY轴座標
IMAGE_ENLARGE = 11  # 拡大比例

HEART_COLOR = "#EEAEEE"  #ハートの色
